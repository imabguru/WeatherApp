...
import { WeatherAppProps, WeatherApp } from "./weather-app";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/weather-app.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <weather-app message="world!"></weather-app>
   */
  return class WeatherAppBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): WeatherAppProps {
      const attrs = this.parseAttributes<WeatherAppProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<WeatherApp {...this.props} />);
    }
